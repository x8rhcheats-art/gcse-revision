...
module.exports = {
  ...
  biology: {
    ...
    mcqBanks: ['tools/biology/mcq-bank-1.json', 'tools/biology/mcq-bank-2.json', 'tools/biology/mcq-bank-3.json', 'tools/biology/mcq-bank-4.json', 'tools/biology/mcq-bank-5.json', 'tools/biology/mcq-bank-6.json'],
